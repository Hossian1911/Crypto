...
def make_excel() -> Path:
    ...
    for sym in targets:
        ...
        ws.append(["", "Cross-exchange Max Leverage", f"{summary['max_leverage']['display']} ({summary['max_leverage']['exchange']})", ""]) 
        ws.append(["", "Global Min MMR", f"{summary['min_mmr']['display']} ({summary['min_mmr']['exchange']})", ""]) 
        ws.append(["", "", "", ""]) 
